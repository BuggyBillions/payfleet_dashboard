                         ...
                         <div className="w-full md:w-52 bg-[#F9FAFB] border-b md:border-b-0 md:border-r border-gray-200/80 p-5 flex flex-col">
                              ...
                              <nav className="flex flex-col space-y-1">
                                   ...
                                   <button
                                        ...
                                        className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-xs font-semibold transition ${isLockedView ? "cursor-not-allowed opacity-60" : "cursor-pointer"
                                             } ${selectedMethod === "card"
                                   ...
                                   <button
                                        ...
                                        className={`flex items-center justify-between px-3 py-2.5 rounded-lg text-xs font-bold transition relative ${isLockedView ? "cursor-not-allowed" : "cursor-pointer"
                                             } ${selectedMethod === "transfer"
                                                  ? "bg-white text-primary shadow-2xs "
                                                  : "text-gray-700 hover:bg-gray-200/60"
                                             }`}
                                   >
                                        <span className="border-r-3 bor border-primary h-4 absolute right-0"></span>
                                                       ...
                                                       <div className="grid grid-cols-3 gap-1.5">
                                                            {[50000, 100000, 250000, 500000, 700000, 1000000].map((amt) => (
                                                                 <button
                                                                      ...
                                                                      className={`py-1.5 px-2 text-xs font-semibold rounded border transition cursor-pointer text-center ${customAmountStr === amt.toString()
                                             ...
                                             >
                                                  ...
                                                  <div className="w-full max-w-xs flex flex-col items-center">
                                                       <div className="flex items-center justify-between w-full px-4">
                                                            ...
                                                            <div className="flex flex-col items-center gap-1">
                                                                 <div
                                                                      className={`w-6 h-6 rounded-full flex items-center justify-center text-xs transition-all duration-300 ${isReceived
                                                                 ...
                                                                 <span
                                                                      className={`text-[11px] font-medium transition-colors ${isReceived ? "text-primary font-bold" : "text-gray-400"
                                                                           }`}
                                                                 >
                                                                      Received
                                                                 </span>
