...
const Deposit: React.FC<DepositModalProps> = ({
     ...
     useEffect(() => {
          ...
          getAccount(companyId)
               ...
               .catch(() => {
                    if (active) toast.error("Failed to load bank account details");
               })
               .finally(() => {
                                             ...
                                             <div className="grid grid-cols-3 gap-1.5">
                                                  {[50000, 100000, 250000, 500000, 700000, 1000000].map((amt) => (
                                                       <button
                                                            ...
                                                            className={`py-1.5 px-2 text-xs font-semibold rounded border transition cursor-pointer text-center ${amountStr === amt.toString()
