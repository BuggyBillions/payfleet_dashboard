...
const Deposit: React.FC<DepositModalProps> = ({
  ...
  const handleMethodSelect = (method: PaymentMethod) => {
    ...
    if (method === "transfer" || method === "bank") {
      ...
      toast.info(`Please use Transfer or Bank. ${method.toUpperCase()} channel is currently in maintenance.`);
    }
  };
  ...
  const handleProceedToDetails = async () => {
    ...
    if (companyId) {
      ...
      try {
        ...
        // Fallback to client-generated reference if backend is offline/simulated
        console.warn("Backend funding notification error (proceeding in simulation mode):", getErrorMessage(error));
      } finally {
          ...
          <div className="w-full md:w-52 bg-[#F9FAFB] border-b md:border-b-0 md:border-r border-gray-200/80 p-5 flex flex-col">
            ...
            <nav className="flex flex-col space-y-1">
              ...
              <button
                ...
                className={`flex items-center justify-between px-3 py-2.5 rounded-lg text-xs font-bold transition relative ${
                  isLockedView ? "cursor-not-allowed" : "cursor-pointer"
                } ${
              ...
              >
                <span className="border-r-3 border-primary h-4 absolute right-0"></span>
              ...
              >
                <LuBuilding size={16} className={selectedMethod === "bank" ? "text-primary" : "text-gray-500"} />
                <span>Bank</span>
              </button>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative flex items-center">
                        ...
                        <FormattedInput
                          ...
                          className="w-full h-12 pl-8 pr-3 text-lg font-bold text-gray-800 bg-[#F9FAFB] border border-gray-200 rounded-lg focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition"
                          autoFocus
                        />
                      </div>
                    </div>
                    ...
                    <div className="w-full max-w-xs px-2">
                      <div className="flex items-center justify-between relative">
                        ...
                        <div className="flex flex-col items-center gap-1">
                          <div className="w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center text-xs font-bold shadow-xs">
                ...
                {view === "success" && (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-500">
                        Your deposit of <strong className="text-primary">{formattedAmountText}</strong> has been credited to your Payfleet wallet.
                      </p>
                    </div>
